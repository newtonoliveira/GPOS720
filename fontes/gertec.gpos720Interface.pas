...
begin
  TRegTypes.RegisterType('gertec.gpos720Interface.JAnimator', TypeInfo(gertec.gpos720Interface.JAnimator));
  TRegTypes.RegisterType('gertec.gpos720Interface.JAnimator_AnimatorListener', TypeInfo(gertec.gpos720Interface.JAnimator_AnimatorListener));
  TRegTypes.RegisterType('gertec.gpos720Interface.JAnimator_AnimatorPauseListener', TypeInfo(gertec.gpos720Interface.JAnimator_AnimatorPauseListener));
  TRegTypes.RegisterType('gertec.gpos720Interface.JKeyframe', TypeInfo(gertec.gpos720Interface.JKeyframe));
  TRegTypes.RegisterType('gertec.gpos720Interface.JLayoutTransition', TypeInfo(gertec.gpos720Interface.JLayoutTransition));
  TRegTypes.RegisterType('gertec.gpos720Interface.JLayoutTransition_TransitionListener', TypeInfo(gertec.gpos720Interface.JLayoutTransition_TransitionListener));
  TRegTypes.RegisterType('gertec.gpos720Interface.JPropertyValuesHolder', TypeInfo(gertec.gpos720Interface.JPropertyValuesHolder));
  TRegTypes.RegisterType('gertec.gpos720Interface.JStateListAnimator', TypeInfo(gertec.gpos720Interface.JStateListAnimator));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTimeInterpolator', TypeInfo(gertec.gpos720Interface.JTimeInterpolator));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTypeConverter', TypeInfo(gertec.gpos720Interface.JTypeConverter));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTypeEvaluator', TypeInfo(gertec.gpos720Interface.JTypeEvaluator));
  TRegTypes.RegisterType('gertec.gpos720Interface.JValueAnimator', TypeInfo(gertec.gpos720Interface.JValueAnimator));
  TRegTypes.RegisterType('gertec.gpos720Interface.JValueAnimator_AnimatorUpdateListener', TypeInfo(gertec.gpos720Interface.JValueAnimator_AnimatorUpdateListener));
  TRegTypes.RegisterType('gertec.gpos720Interface.JPathMotion', TypeInfo(gertec.gpos720Interface.JPathMotion));
  TRegTypes.RegisterType('gertec.gpos720Interface.JScene', TypeInfo(gertec.gpos720Interface.JScene));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTransition', TypeInfo(gertec.gpos720Interface.JTransition));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTransition_EpicenterCallback', TypeInfo(gertec.gpos720Interface.JTransition_EpicenterCallback));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTransition_TransitionListener', TypeInfo(gertec.gpos720Interface.JTransition_TransitionListener));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTransitionManager', TypeInfo(gertec.gpos720Interface.JTransitionManager));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTransitionPropagation', TypeInfo(gertec.gpos720Interface.JTransitionPropagation));
  TRegTypes.RegisterType('gertec.gpos720Interface.JTransitionValues', TypeInfo(gertec.gpos720Interface.JTransitionValues));
  TRegTypes.RegisterType('gertec.gpos720Interface.JInterpolator', TypeInfo(gertec.gpos720Interface.JInterpolator));
  TRegTypes.RegisterType('gertec.gpos720Interface.JToolbar_LayoutParams', TypeInfo(gertec.gpos720Interface.JToolbar_LayoutParams));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgertec_Logger', TypeInfo(gertec.gpos720Interface.Jgertec_Logger));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgertec_a_a', TypeInfo(gertec.gpos720Interface.Jgertec_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgertec_a_a_a', TypeInfo(gertec.gpos720Interface.Jgertec_a_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_a_a_a', TypeInfo(gertec.gpos720Interface.Ja_a_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIGEDI', TypeInfo(gertec.gpos720Interface.JIGEDI));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI', TypeInfo(gertec.gpos720Interface.JGEDI));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_1', TypeInfo(gertec.gpos720Interface.JGEDI_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_st_Control_Callbacks', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_st_Control_Callbacks));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGediNative', TypeInfo(gertec.gpos720Interface.JGediNative));
  TRegTypes.RegisterType('gertec.gpos720Interface.JICL', TypeInfo(gertec.gpos720Interface.JICL));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_a', TypeInfo(gertec.gpos720Interface.Jgedi_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIAUDIO', TypeInfo(gertec.gpos720Interface.JIAUDIO));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_a_a', TypeInfo(gertec.gpos720Interface.Jgedi_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_a_b', TypeInfo(gertec.gpos720Interface.Jgedi_a_b));
  TRegTypes.RegisterType('gertec.gpos720Interface.JICLOCK', TypeInfo(gertec.gpos720Interface.JICLOCK));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_b', TypeInfo(gertec.gpos720Interface.Jgedi_b));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_a_c', TypeInfo(gertec.gpos720Interface.Jgedi_a_c));
  TRegTypes.RegisterType('gertec.gpos720Interface.JICRYPT', TypeInfo(gertec.gpos720Interface.JICRYPT));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_c', TypeInfo(gertec.gpos720Interface.Jgedi_c));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_a_d', TypeInfo(gertec.gpos720Interface.Jgedi_a_d));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_a_e', TypeInfo(gertec.gpos720Interface.Jgedi_a_e));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIINFO', TypeInfo(gertec.gpos720Interface.JIINFO));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_d', TypeInfo(gertec.gpos720Interface.Jgedi_d));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_f', TypeInfo(gertec.gpos720Interface.Ja_f));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jf_1', TypeInfo(gertec.gpos720Interface.Jf_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIKBD', TypeInfo(gertec.gpos720Interface.JIKBD));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_e', TypeInfo(gertec.gpos720Interface.Jgedi_e));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_g', TypeInfo(gertec.gpos720Interface.Ja_g));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_1', TypeInfo(gertec.gpos720Interface.Jg_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_10', TypeInfo(gertec.gpos720Interface.Jg_10));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_11', TypeInfo(gertec.gpos720Interface.Jg_11));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_12', TypeInfo(gertec.gpos720Interface.Jg_12));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_13', TypeInfo(gertec.gpos720Interface.Jg_13));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_2', TypeInfo(gertec.gpos720Interface.Jg_2));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_3', TypeInfo(gertec.gpos720Interface.Jg_3));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_4', TypeInfo(gertec.gpos720Interface.Jg_4));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_5', TypeInfo(gertec.gpos720Interface.Jg_5));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_6', TypeInfo(gertec.gpos720Interface.Jg_6));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_7', TypeInfo(gertec.gpos720Interface.Jg_7));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_8', TypeInfo(gertec.gpos720Interface.Jg_8));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jg_9', TypeInfo(gertec.gpos720Interface.Jg_9));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIKMS', TypeInfo(gertec.gpos720Interface.JIKMS));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_g', TypeInfo(gertec.gpos720Interface.Jgedi_g));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_h', TypeInfo(gertec.gpos720Interface.Ja_h));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jc_a', TypeInfo(gertec.gpos720Interface.Jc_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jh_1', TypeInfo(gertec.gpos720Interface.Jh_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jh_2', TypeInfo(gertec.gpos720Interface.Jh_2));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIMSR', TypeInfo(gertec.gpos720Interface.JIMSR));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_i', TypeInfo(gertec.gpos720Interface.Jgedi_i));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_i', TypeInfo(gertec.gpos720Interface.Ja_i));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ji_1', TypeInfo(gertec.gpos720Interface.Ji_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIPM', TypeInfo(gertec.gpos720Interface.JIPM));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_j', TypeInfo(gertec.gpos720Interface.Jgedi_j));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_j', TypeInfo(gertec.gpos720Interface.Ja_j));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIPRNTR', TypeInfo(gertec.gpos720Interface.JIPRNTR));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_k', TypeInfo(gertec.gpos720Interface.Jgedi_k));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_k', TypeInfo(gertec.gpos720Interface.Ja_k));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jk_1', TypeInfo(gertec.gpos720Interface.Jk_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.JISMART', TypeInfo(gertec.gpos720Interface.JISMART));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_l', TypeInfo(gertec.gpos720Interface.Jgedi_l));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_l', TypeInfo(gertec.gpos720Interface.Ja_l));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jl_1', TypeInfo(gertec.gpos720Interface.Jl_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jl_2', TypeInfo(gertec.gpos720Interface.Jl_2));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jl_3', TypeInfo(gertec.gpos720Interface.Jl_3));
  TRegTypes.RegisterType('gertec.gpos720Interface.JISYS', TypeInfo(gertec.gpos720Interface.JISYS));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_m', TypeInfo(gertec.gpos720Interface.Jgedi_m));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_m', TypeInfo(gertec.gpos720Interface.Ja_m));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_n', TypeInfo(gertec.gpos720Interface.Ja_n));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_o', TypeInfo(gertec.gpos720Interface.Ja_o));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jo_1', TypeInfo(gertec.gpos720Interface.Jo_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CL_e_ISO_Level', TypeInfo(gertec.gpos720Interface.JGEDI_CL_e_ISO_Level));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CL_e_ISO_Type', TypeInfo(gertec.gpos720Interface.JGEDI_CL_e_ISO_Type));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CL_e_MF_KeyType', TypeInfo(gertec.gpos720Interface.JGEDI_CL_e_MF_KeyType));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CL_e_MF_Type', TypeInfo(gertec.gpos720Interface.JGEDI_CL_e_MF_Type));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CRYPT_e_Op', TypeInfo(gertec.gpos720Interface.JGEDI_CRYPT_e_Op));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_FS_e_Storage', TypeInfo(gertec.gpos720Interface.JGEDI_FS_e_Storage));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_INFO_e_ControlNumber', TypeInfo(gertec.gpos720Interface.JGEDI_INFO_e_ControlNumber));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_INFO_e_Test', TypeInfo(gertec.gpos720Interface.JGEDI_INFO_e_Test));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KBD_e_Key', TypeInfo(gertec.gpos720Interface.JGEDI_KBD_e_Key));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KBD_e_PowerKeyMode', TypeInfo(gertec.gpos720Interface.JGEDI_KBD_e_PowerKeyMode));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_e_BLOCKTYPE', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_e_BLOCKTYPE));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_e_EncMode', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_e_EncMode));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_e_KEYPURPOSE', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_e_KEYPURPOSE));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_e_KEYTYPE', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_e_KEYTYPE));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_e_KEYTYPE_LENGTH', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_e_KEYTYPE_LENGTH));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_e_OP', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_e_OP));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_LED_e_Id', TypeInfo(gertec.gpos720Interface.JGEDI_LED_e_Id));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_MSR_e_Status', TypeInfo(gertec.gpos720Interface.JGEDI_MSR_e_Status));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_PRNTR_e_Alignment', TypeInfo(gertec.gpos720Interface.JGEDI_PRNTR_e_Alignment));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_PRNTR_e_BarCodeType', TypeInfo(gertec.gpos720Interface.JGEDI_PRNTR_e_BarCodeType));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_PRNTR_e_Status', TypeInfo(gertec.gpos720Interface.JGEDI_PRNTR_e_Status));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_SMART_e_MemoryCardType', TypeInfo(gertec.gpos720Interface.JGEDI_SMART_e_MemoryCardType));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_SMART_e_Slot', TypeInfo(gertec.gpos720Interface.JGEDI_SMART_e_Slot));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_SMART_e_Status', TypeInfo(gertec.gpos720Interface.JGEDI_SMART_e_Status));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_SMART_e_Type', TypeInfo(gertec.gpos720Interface.JGEDI_SMART_e_Type));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_SMART_e_Voltage', TypeInfo(gertec.gpos720Interface.JGEDI_SMART_e_Voltage));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_SYS_e_SecuritySetup', TypeInfo(gertec.gpos720Interface.JGEDI_SYS_e_SecuritySetup));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_e_Ret', TypeInfo(gertec.gpos720Interface.JGEDI_e_Ret));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGediException', TypeInfo(gertec.gpos720Interface.JGediException));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_f', TypeInfo(gertec.gpos720Interface.Jgedi_f));
  TRegTypes.RegisterType('gertec.gpos720Interface.JILED', TypeInfo(gertec.gpos720Interface.JILED));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jgedi_h', TypeInfo(gertec.gpos720Interface.Jgedi_h));
  TRegTypes.RegisterType('gertec.gpos720Interface.JIEnums', TypeInfo(gertec.gpos720Interface.JIEnums));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_AUTH_st_Data', TypeInfo(gertec.gpos720Interface.JGEDI_AUTH_st_Data));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CLOCK_st_RTC', TypeInfo(gertec.gpos720Interface.JGEDI_CLOCK_st_RTC));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CL_st_ISO_PollingInfo', TypeInfo(gertec.gpos720Interface.JGEDI_CL_st_ISO_PollingInfo));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CL_st_MF_ActivateInfo', TypeInfo(gertec.gpos720Interface.JGEDI_CL_st_MF_ActivateInfo));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CL_st_MF_Key', TypeInfo(gertec.gpos720Interface.JGEDI_CL_st_MF_Key));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CL_st_ResetEMVInfo', TypeInfo(gertec.gpos720Interface.JGEDI_CL_st_ResetEMVInfo));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_CRYPT_st_RSAKeyGen', TypeInfo(gertec.gpos720Interface.JGEDI_CRYPT_st_RSAKeyGen));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KBD_st_Info', TypeInfo(gertec.gpos720Interface.JGEDI_KBD_st_Info));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_st_CapturePINBlockInfo', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_st_CapturePINBlockInfo));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_st_Control', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_st_Control));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_st_Data', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_st_Data));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_st_KB', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_st_KB));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_st_PINBlock', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_st_PINBlock));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_KMS_st_SaveKey', TypeInfo(gertec.gpos720Interface.JGEDI_KMS_st_SaveKey));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_MSR_st_LastErrors', TypeInfo(gertec.gpos720Interface.JGEDI_MSR_st_LastErrors));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_MSR_st_Tracks', TypeInfo(gertec.gpos720Interface.JGEDI_MSR_st_Tracks));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_PRNTR_st_BarCodeConfig', TypeInfo(gertec.gpos720Interface.JGEDI_PRNTR_st_BarCodeConfig));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_PRNTR_st_PictureConfig', TypeInfo(gertec.gpos720Interface.JGEDI_PRNTR_st_PictureConfig));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_PRNTR_st_StringConfig', TypeInfo(gertec.gpos720Interface.JGEDI_PRNTR_st_StringConfig));
  TRegTypes.RegisterType('gertec.gpos720Interface.JGEDI_SMART_st_ResetInfo', TypeInfo(gertec.gpos720Interface.JGEDI_SMART_st_ResetInfo));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jsdk4_a_a', TypeInfo(gertec.gpos720Interface.Jsdk4_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jsdk4_a_a_a', TypeInfo(gertec.gpos720Interface.Jsdk4_a_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_a_a', TypeInfo(gertec.gpos720Interface.Ja_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_b', TypeInfo(gertec.gpos720Interface.Ja_b));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jb_a', TypeInfo(gertec.gpos720Interface.Jb_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jb_a_a', TypeInfo(gertec.gpos720Interface.Jb_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_c', TypeInfo(gertec.gpos720Interface.Ja_c));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jc_a_a', TypeInfo(gertec.gpos720Interface.Jc_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_d', TypeInfo(gertec.gpos720Interface.Ja_d));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jd_a', TypeInfo(gertec.gpos720Interface.Jd_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jd_a_a', TypeInfo(gertec.gpos720Interface.Jd_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_e', TypeInfo(gertec.gpos720Interface.Ja_e));
  TRegTypes.RegisterType('gertec.gpos720Interface.Je_a', TypeInfo(gertec.gpos720Interface.Je_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Je_a_a', TypeInfo(gertec.gpos720Interface.Je_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jsdk4_b_a', TypeInfo(gertec.gpos720Interface.Jsdk4_b_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jsdk4_b_a_a', TypeInfo(gertec.gpos720Interface.Jsdk4_b_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jb_a_a_a', TypeInfo(gertec.gpos720Interface.Jb_a_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jb_b', TypeInfo(gertec.gpos720Interface.Jb_b));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jb_b_a', TypeInfo(gertec.gpos720Interface.Jb_b_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jb_b_a_a', TypeInfo(gertec.gpos720Interface.Jb_b_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jsdk4_c_a', TypeInfo(gertec.gpos720Interface.Jsdk4_c_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jsdk4_c_a_a', TypeInfo(gertec.gpos720Interface.Jsdk4_c_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jc_a_b', TypeInfo(gertec.gpos720Interface.Jc_a_b));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jc_b', TypeInfo(gertec.gpos720Interface.Jc_b));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jlibbasebinder_a', TypeInfo(gertec.gpos720Interface.Jlibbasebinder_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.JBankCard', TypeInfo(gertec.gpos720Interface.JBankCard));
  TRegTypes.RegisterType('gertec.gpos720Interface.JCore', TypeInfo(gertec.gpos720Interface.JCore));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jlibbasebinder_Printer', TypeInfo(gertec.gpos720Interface.Jlibbasebinder_Printer));
  TRegTypes.RegisterType('gertec.gpos720Interface.JPrinter_Align', TypeInfo(gertec.gpos720Interface.JPrinter_Align));
  TRegTypes.RegisterType('gertec.gpos720Interface.JPrinter_BarcodeType', TypeInfo(gertec.gpos720Interface.JPrinter_BarcodeType));
  TRegTypes.RegisterType('gertec.gpos720Interface.JPrinter_BarcodeWidth', TypeInfo(gertec.gpos720Interface.JPrinter_BarcodeWidth));
  TRegTypes.RegisterType('gertec.gpos720Interface.JPrinter_Font', TypeInfo(gertec.gpos720Interface.JPrinter_Font));
  TRegTypes.RegisterType('gertec.gpos720Interface.JRspCode', TypeInfo(gertec.gpos720Interface.JRspCode));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_1', TypeInfo(gertec.gpos720Interface.Ja_1));
  TRegTypes.RegisterType('gertec.gpos720Interface.Ja_2', TypeInfo(gertec.gpos720Interface.Ja_2));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jlibbasebinder_a_a', TypeInfo(gertec.gpos720Interface.Jlibbasebinder_a_a));
  TRegTypes.RegisterType('gertec.gpos720Interface.Jlibbasebinder_b', TypeInfo(gertec.gpos720Interface.Jlibbasebinder_b));
end;
