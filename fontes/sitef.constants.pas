...
const
  ...
  CONTINUA_SITEF = 10000;

  TRANSACAO_AUTORIZADA = '00';

  TXT_SITEF_CONECTADO = 'SiTef Conectado';
  TXT_SITEF_CONECTANDO = 'Conectando Sitef';
  TXT_SITEF_INSIRAOUPASSEOCARTAO =
    'Insira ou passe ou aproxime o cartão na leitora';
  ...
  FORMAPAGAMENTO_REIMPRESSAO = 114;
  FORMAPAGAMENTO_LIMPEZA_TABELAS = 772;
